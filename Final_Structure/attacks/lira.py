...
from Third_Party_Code.MIADisparity.miae.attacks.lira_mia import LiraAuxiliaryInfo, LiraAttack, LiraModelAccess
...
def lira_mia(target_model_path, loaders, config):
    ...
    aux_info = LiraAuxiliaryInfo(config)
    attack = LiraAttack(model_access, aux_info)
