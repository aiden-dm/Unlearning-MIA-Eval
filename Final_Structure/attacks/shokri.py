...
# Third party imports
from Third_Party_Code.MIADisparity.miae.attacks.shokri_mia import ShokriAttack, ShokriModelAccess, ShokriAuxiliaryInfo
...
def shokri_mia(target_model_path, loaders, config):
    ...
    aux_info = ShokriAuxiliaryInfo(config)
    attack = ShokriAttack(model_access, aux_info)
