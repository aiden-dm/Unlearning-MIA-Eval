...
from Third_Party_Code.MIADisparity.miae.attacks.reference_mia import ReferenceAuxiliaryInfo, ReferenceAttack, ReferenceModelAccess
...
def reference_mia(target_model_path, loaders, config):
    ...
    aux_info = ReferenceAuxiliaryInfo(config)
    attack = ReferenceAttack(model_access, aux_info)
