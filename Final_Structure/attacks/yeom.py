...
# Third party imports
from Third_Party_Code.MIADisparity.miae.attacks.yeom_mia import YeomAttack, YeomModelAccess, YeomAuxiliaryInfo
...
def yeom_mia(target_model_path, loaders, config):
    ...
    aux_info = YeomAuxiliaryInfo(config)
    attack = YeomAttack(model_access, aux_info)
